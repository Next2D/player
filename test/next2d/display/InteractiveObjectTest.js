...
describe("InteractiveObject.js continuousPress test", function()
{

    it("default test case1", function()
    {
        let io = new InteractiveObject();
        expect(io.continuousPress).toBe(true);
    });

    it("default test case2", function()
    {
        let io = new InteractiveObject();
        io.continuousPress = null;
        expect(io.continuousPress).toBe(false);
    });
    ...
    {
        let io = new InteractiveObject();
        io.continuousPress = { "toString":function () { return 1 } };
        expect(io.continuousPress).toBe(true);
    });
    ...
    {
        let io = new InteractiveObject();
        io.continuousPress = { "toString":function () { return "1a" } };
        expect(io.continuousPress).toBe(true);
    });
