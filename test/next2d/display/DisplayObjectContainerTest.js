...
describe("DisplayObjectContainer.js toString test", function()
{
    it("toString test success", function()
    {
        let container = new DisplayObjectContainer();
        expect(container.toString()).toBe("[object DisplayObjectContainer]");
    });

});

describe("DisplayObjectContainer.js static toString test", function()
{

    it("static toString test", function()
    {
        expect(DisplayObjectContainer.toString()).toBe("[class DisplayObjectContainer]");
    });

});

describe("DisplayObjectContainer.js namespace test", function()
{

    it("namespace test public", function()
    {
        const object = new DisplayObjectContainer();
        expect(object.namespace).toBe("next2d.display.DisplayObjectContainer");
    });

    it("namespace test static", function()
    {
        expect(DisplayObjectContainer.namespace).toBe("next2d.display.DisplayObjectContainer");
    });
...
describe("DisplayObjectContainer.js mouseChildren test", function()
{
    ...
    {
        let doc = new DisplayObjectContainer();
        doc.mouseChildren = { "toString":function () { return 1 } };
        expect(doc.mouseChildren).toBe(true);
    });
    ...
    {
        let doc = new DisplayObjectContainer();
        doc.mouseChildren = { "toString":function () { return "1a" } };
        expect(doc.mouseChildren).toBe(true);
    });
