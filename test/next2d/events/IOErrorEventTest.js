...
describe("IOErrorEvent.js toString test", function()
{
    // toString
...
describe("IOErrorEvent.js static toString test", function()
{
...
describe("IOErrorEvent.js namespace test", function()
{
...
describe("IOErrorEvent.js property test", function()
{
    ...
    {
        expect(new IOErrorEvent() instanceof IOErrorEvent).toBe(true);
    });
