...
flowchart TB
    ...
    Rendering4 -->|cache| TextureCache["texture cache"]
    ...
    style CoordinatesDB fill:#f0f0f0,stroke:#666,stroke-width:2px
    style TextureCache fill:#f0f0f0,stroke:#666,stroke-width:2px
```
