import {$getFloat32Array6, $getFloat32Array8, $renderPlayer} from "../src/renderer/RenderUtil";
import {BlendModeImpl} from "../src/interface/BlendModeImpl";
...
{
    protected _$instanceId: number;
    protected _$loaderInfoId: number;
    protected _$characterId: number;
    protected _$clipDepth: number;
    protected _$depth: number;
    protected _$isMask: boolean;
    protected _$updated: boolean;
    protected readonly _$matrix: Float32Array;
    protected _$blendMode: BlendModeImpl;
    protected readonly _$colorTransform: Float32Array;
    protected _$filters: FilterArrayImpl | null;
    protected _$visible: boolean;
    protected _$maskId: number;
    protected _$maskMatrix: Float32Array | null;
    protected _$xMin: number;
    protected _$yMin: number;
    protected _$xMax: number;
    protected _$yMax: number;
     ...
     * @private
     */
    _$canApply (filters: FilterArrayImpl)
    {
