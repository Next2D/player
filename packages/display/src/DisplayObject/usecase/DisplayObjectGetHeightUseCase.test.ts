import { execute } from "./DisplayObjectGetHeightUseCase";
...
describe("DisplayObjectGetHeightUseCase.js test", () =>
{
    ...
    it("execute test shape case2", () =>
    {
        ...
        expect(execute(shape)).toBe(540);
    });

    it("execute test video case1", () =>
    {
        const video = new Video(100, 300);
        expect(execute(video)).toBe(300);
    });
    ...
    it("execute test text case2", () =>
    {
        ...
        expect(execute(textField)).toBe(300);
    });
    ...
    it("execute test container case1", () =>
    {
        ...
        expect(execute(container)).toBe(300);
    });
    ...
    it("execute test container case2", () =>
    {
        ...
        expect(execute(container)).toBe(960);
    });
});