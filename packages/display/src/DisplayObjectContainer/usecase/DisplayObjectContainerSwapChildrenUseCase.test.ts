import { execute } from "./DisplayObjectContainerSwapChildrenUseCase";
import { Shape } from "../../Shape";
import { DisplayObjectContainer } from "../../DisplayObjectContainer";
import { describe, expect, it } from "vitest";

describe("DisplayObjectContainerSwapChildrenUseCase.js test", () =>
{
    it("execute test case1", () =>
    {
        ...
        execute(container, shape1, shape2);
    ...
    it("execute test case2", () =>
    {
        ...
        execute(container, shape0, shape3);
