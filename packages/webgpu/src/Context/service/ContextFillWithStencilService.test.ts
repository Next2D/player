...
describe("ContextFillWithStencilService", () =>
{
    ...
    describe("pass 1: stencil write", () =>
    {
        it("should get stencil_write_atlas pipeline", () =>
        {
            ...
            execute(renderPassEncoder, pipelineManager, vertexBuffer, 12, bindGroup, 0);
        ...
        it("should set bind group with dynamic offset for write pass", () =>
        {
            const renderPassEncoder = createMockRenderPassEncoder();
            const pipelineManager = createMockPipelineManager();
            const vertexBuffer = createMockVertexBuffer();
            ...
            execute(renderPassEncoder, pipelineManager, vertexBuffer, 12, bindGroup, 512);

            expect(renderPassEncoder.setBindGroup).toHaveBeenCalledWith(0, bindGroup, [512]);
        });
        ...
        it("should draw with correct vertex count for write pass", () =>
        {
            ...
            execute(renderPassEncoder, pipelineManager, vertexBuffer, 24, bindGroup, 0);
    ...
    describe("both passes", () =>
    {
        ...
        it("should draw same vertex count for both passes", () =>
        {
            ...
            execute(renderPassEncoder, pipelineManager, vertexBuffer, 36, bindGroup, 0);
    ...
    describe("edge cases", () =>
    {
        it("should handle zero vertex count", () =>
        {
            ...
            execute(renderPassEncoder, pipelineManager, vertexBuffer, 0, bindGroup, 0);
