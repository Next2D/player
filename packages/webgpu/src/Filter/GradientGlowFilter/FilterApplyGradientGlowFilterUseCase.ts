...
/**
 * @description グラデーショングローフィルター処理の設定
 *              Gradient glow filter processing configuration
 */
interface IGradientGlowConfig {
    device: GPUDevice;
 ...
 * @param  {IGradientGlowConfig} config - WebGPUリソース設定
