...
export const execute = (
    ...
    const textureObject = filterApplyBitmapFilterUseCase(
        ...
        $intToR(highlight_color, highlight_alpha, true),
        $intToG(highlight_color, highlight_alpha, true),
        $intToB(highlight_color, highlight_alpha, true),
        highlight_alpha,
        $intToR(shadow_color, shadow_alpha, true),
        $intToG(shadow_color, shadow_alpha, true),
        $intToB(shadow_color, shadow_alpha, true),
        shadow_alpha
    );
