import { execute } from "./ContextRadialGradientFillUseCase";
...
vi.mock("../../WebGLUtil.ts", async (importOriginal) => {
    ...
    return {
        ...
        $context: {
            ...
            $stack: [new Float32Array([1, 0, 0, 1, 0, 0])],
            save: vi.fn(),
            restore: vi.fn(),
            transform: vi.fn()
        },
...
describe("ContextRadialGradientFillUseCase.js method test", () =>
{
    beforeEach(() => {
        vi.clearAllMocks();
    ...
    it("test case - should execute radial gradient fill shader", () =>
    {
