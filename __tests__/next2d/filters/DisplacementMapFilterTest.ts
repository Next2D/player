...
//     {
//         let filter = new DisplacementMapFilter(new Image(100, 100));
//         expect(filter.mapBitmap instanceof Image).toBe(true);
//     });
//
//     it("mapBitmap test success case2", () =>
//     {
//         let filter = new DisplacementMapFilter(new Image());
...
//     it("clone test", () =>
//     {
//         let bitmapData = new Image(100, 100);
//         let point = new Point();
//         let filter = new DisplacementMapFilter(
//             bitmapData,
//             point,
...
//
//         // clone check
//         expect(clone.mapBitmap instanceof Image).toBe(true);
