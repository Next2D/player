import type { ITextData } from "../../packages/renderer/src/interface/ITextData";
import type { ITextSetting } from "../../packages/renderer/src/interface/ITextSetting";
import { execute as textFiledGetAlignOffsetService } from "../../packages/renderer/src/TextField/service/TextFiledGetAlignOffsetService";
import { execute as textFieldGenerateFontStyleService } from "../../packages/renderer/src/TextField/service/TextFieldGenerateFontStyleService";
import { $intToRGBA } from "../../packages/renderer/src/RendererUtil";
...
export const execute = (
    ...
    if (canvas) {
        ...
        if (canvas.height !== text_setting.height) canvas.height = text_setting.height;
    } else {
